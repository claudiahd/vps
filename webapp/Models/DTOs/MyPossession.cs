...
namespace VPS.Models.DTOs
{
    ...
    public class MyPossession
    {
        ...
        public MyPossession(Possessions p)
        {
            ...
            PossessionTime = p.PossessionDateTime.Hour + ":" + p.PossessionDateTime.Minute;
            ...
            if (p.ReturnDateTime.HasValue)
            {
                ...
                ReturnTime = p.ReturnDateTime.Value.Hour + ":" + p.ReturnDateTime.Value.Minute ;
            }
        ...
        public MyVehicleIssue myVehicleIssue { get; set; }
    }

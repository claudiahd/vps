...
||||||| .r47
        [ValidateAntiForgeryToken]
        //public ActionResult Create([Bind(Include = "VehicleIssueID,VehicleID,IssueDetails,ImagePath,ImageThumbnailPath,IssueReportDate,IsIssueFixed,IssueFixeDate")] VehiclesIssues vehiclesIssues)
